...
function renderIncomeTracker() {
  ...
  incomeData.sort((a, b) => new Date(b.date) - new Date(a.date)); // Sort by date descending
  ...
  document.getElementById(
    "cumulative-total"
  ).textContent = `££{cumulativeTotal.toFixed(2)}`;
}
...
document.getElementById("income-form").addEventListener("submit", function (e) {
  ...
  // Clear form (except date for quick entry)
